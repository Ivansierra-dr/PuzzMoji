...
const LandingPage = () => {
  ...
  useEffect(() => {
    // Si hay el parámetro howtoplay=true, hacer scroll a la sección "Cómo jugar"
    if (searchParams.get('howtoplay') === 'true') {
      setTimeout(() => {
      ...
      }, 100); // Pequeño delay para asegurar que la página esté renderizada
    }
  }, [searchParams]);
  ...
  return (
    <>
      <SEO
        title="PuzzMoji - El juego diario de emojis | Adivina la película"
        description="¿Puedes adivinar la película o serie por sus emojis? Nuevo puzzle cada día. Juega gratis ahora."
