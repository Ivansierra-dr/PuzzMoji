...
const ContactPage = () => {
  ...
  return (
    <>
      <SEO
        title="Contacto - PuzzMoji"
        description="Contacta con el equipo de PuzzMoji. Soporte técnico, sugerencias y consultas generales."
        url="https://playpuzzmoji.com/contact"
      />
