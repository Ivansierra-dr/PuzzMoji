...
const TriviaBlog = () => {
  ...
  const categories = {
    all: { name: 'Todos', emoji: '📚' },
    cinema: { name: 'Cine', emoji: '🎬' },
    series: { name: 'Series', emoji: '📺' },
    animation: { name: 'Animación', emoji: '🎨' },
    records: { name: 'Récords', emoji: '🏆' },
    curiosity: { name: 'Curiosidades', emoji: '🤔' }
  };
  ...
  return (
    <>
      <SEO
        title="Curiosidades - PuzzMoji"
        description="Datos fascinantes, récords increíbles y secretos del mundo del cine y la TV en PuzzMoji."
        url="https://playpuzzmoji.com/trivia"
      />
      <div className="legal-modal">
        <div className="legal-content">
          ...
          <div className="legal-intro">
            <p>Datos fascinantes, récords increíbles y secretos del mundo del cine y la TV. Filtra por categoría o explora todas.</p>
          </div>
          ...
          <div className="articles-grid">
            {filteredItems.map(item => (
              <article key={item.id} className="trivia-card">
                ...
                <h3 className="trivia-title">{item.title}</h3>
